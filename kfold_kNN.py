...
def experiment_kNN(dataset_name, w_TAOT, RUN = True):
    ...
    plot_file = os.path.join("kfold_kNN_data","plots", "Comparison on " + dataset_name + eps_name + 'TAOT_only' + ".pdf")
    result_file = os.path.join("kfold_kNN_data", "saved_results","Results on " + dataset_name + eps_name + 'TAOT_only' + '.csv')
    if RUN :
